...
\begin{singlespace}
	...
	\subsection{Existing Depth Sensing Technology}
		...
		\subsubsection{Infrared Depth Sensors}
			...
			Natural sunlight will also blind the sensor by washing out the IR pattern.
		...
		\subsubsection{Radar}
			...
			This is especially problematic when trying to apply a radar system to an autonomous car system; a radar system may not detect a narrow pole or small object in front of it.
