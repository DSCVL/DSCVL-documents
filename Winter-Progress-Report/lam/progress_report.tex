...
\begin{singlespace}
	...
	\section{Current State}
		\subsection{Computer Vision}
			My primary focus during this term was creating a reliable image-recognition model.
			I first started with OpenCV's pre-trained facial/pedestrian SVM classifier.
			As evidenced below, this model isn't extremely ideal for our purposes.
			The algorithm is limited and not very accurate.
			Our design specifications envision our project being able to quickly track multiple humans, this SVM does not yet fufful this requirement.
			The computer vision and object recognition component for this project is completed.
