...
\begin{singlespace}
	...
	\section{Design}
		...
		Origionally, I built the mount to accommodate the LEDDAR M16 LIDAR, however when it became clear that it would not be ready for expo, I adapted the mount to fit the RPLIDAR A1. 
	...
	\begin{enumerate}
		...
		\item Ensure web cam and RPlidar are plugged in, execute with 
			\subitem \codeword{python main.py}
	\end{enumerate}


	\begin{figure}[H]
	\includegraphics[scale=0.1]{expo1.jpg}
