...
\begin{singlespace}
	...
	\section{Current State}
		...
		\subsubsection{Device Mount}
			...
			This mount serves to stabilize the webcam and lidar devices in a stationary position relative to each other so that an accurate calibration can be performed.
			If both devices moved or are not placed in consistent positions, distance information will not be synchronized with object recognition.
			Writing an algorithm to compensate for automatic distance and object recognition calibration is an overly complex task.
			...
			Fortunately, I was able to get distance information working with the RPlidar A1.
