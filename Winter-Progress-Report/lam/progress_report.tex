...
\begin{singlespace}
	...
	\section{Current State}
		\subsection{Computer Vision}
			...
			Recognizing the SVM's weaknesses, I started experimenting with Tensorflow's open source object detection classifier. \cite{tensorflow}
			Unsurprisingly, Tensorflow's powerful network is several magnitudes more accurate than OpenCV's static SVM.
			\begin{figure}[here]
			\includegraphics[scale=0.5, width=\textwidth]{tensorflow.PNG}
